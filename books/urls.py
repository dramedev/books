...
urlpatterns = [
    ...
    path("webhooks/cinetpay/subscription/", views.platform_cinetpay_webhook, name="platform_cinetpay_webhook"),
    ...
    path("checkout/history/export/csv/", views.export_checkout_history_csv, name="export_checkout_history_csv"),
    ...
    path("wholesaler-feed/", views.wholesaler_feed_list, name="wholesaler_feed_list"),
    path("wholesaler-feed/upload/", views.wholesaler_feed_upload, name="wholesaler_feed_upload"),
    path("wholesaler-feed/<int:id>/delete/", views.wholesaler_feed_delete, name="wholesaler_feed_delete"),
    ...
    path("webhooks/cinetpay/invoice/<int:integration_id>/", views.cinetpay_invoice_webhook, name="cinetpay_invoice_webhook"),
